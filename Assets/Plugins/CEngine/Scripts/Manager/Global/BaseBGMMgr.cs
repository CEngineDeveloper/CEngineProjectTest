...
namespace CYM
{
    public sealed class BaseBGMMgr : BaseGFlowMgr
    {
        #region SoundConnection
        private SoundConnection PreSoundConnection;
        private SoundConnection StartSoundConnection;
        private SoundConnection BattleSoundConnection;
        private SoundConnection CreditsSoundConnection;
        private SoundConnection TempSoundConnection;
        #endregion

        #region prop
        public BGMType PreBGMType { get; private set; } = BGMType.MainMenu;
        #endregion
        ...
        /// </summary>
        /// <returns></returns>
        private SoundConnection CreateConnection(List<string> musics, SoundManager.PlayMethod type = SoundManager.PlayMethod.ContinuousPlayThroughWithRandomDelayInRange)
        {
