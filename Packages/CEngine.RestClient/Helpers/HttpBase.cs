...
namespace CYM.RestClient
{
    public static class HttpBase
    {
        ...
        public static bool IsFail { get; private set; }
        public static bool IsSucc => !IsFail;
            ...
            where TResponse: new()
        {
            return CreateRequestAndRetry(options, (RequestException err, ResponseHelper res) => {
                ...
                try
                {
                    ...
                    {
                        var jo = (JObject)JsonConvert.DeserializeObject(res.Text);
                        ...
                        if (data != null ||
                            data!="")
                        {
                            body = JsonConvert.DeserializeObject<TResponse>(data);
                        }
                        if (body == null)
                            body = new TResponse();
                        //body.code = code;
