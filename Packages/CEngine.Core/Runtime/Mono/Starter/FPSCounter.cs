...
namespace CYM
{
	[AddComponentMenu(SysConst.STR_MenuStartter + nameof(FPSCounter))]
	[HideMonoScript]
...
#pragma warning disable 0649
		...
		[SerializeField][HideInInspector] private int _xOffset;
		[SerializeField][HideInInspector] private int _yOffset;
#pragma warning restore 0649
        ...
        public override void OnGUIPaint()
        {
			...
			if (EditorOnly && !Application.isEditor) return;
			if (!IsShow) return;
			if (!BaseGlobal.IsAllLoadEnd) return;
