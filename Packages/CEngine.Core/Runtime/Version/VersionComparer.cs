...
namespace CYM.Ver
{
    internal class VersionComparer : IComparer<Version>
    {
        ...
        private static int ComparePreReleaseVersions(Version x, Version y)
        {
            if (IsPreRelease(x))
            {
            ...
            var xIdentifiers = x.preRelease.Split(Version.IdentifiersSeparator);
            var yIdentifiers = y.preRelease.Split(Version.IdentifiersSeparator);
        ...
        private static bool IsPreRelease(Version semVer)
        {
