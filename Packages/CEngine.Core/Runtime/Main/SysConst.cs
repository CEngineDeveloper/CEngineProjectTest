...
namespace CYM
{
    public partial class SysConst
    {
        ...
        #region bundle name
        public const string BN_Shader = "shader";
        ...
        public const string Dir_GlobalMgr = "GlobalMgr";
        public const string Dir_Main = "Main";
        public const string Dir_Table = "Table";
        public const string Dir_UIMgr = "UIMgr";
        ...
        //全局配置资源的格式路径
        public readonly static string Format_ABSystemAssetPath = "Assets/"+SysConst.Dir_Bundles+"/"+SysConst.Dir_System+"/{0}.asset";
        public readonly static string Format_ResourcesTempAssetPath = "Assets/" + SysConst.Dir_Resources + "/" + SysConst.Dir_Temp + "/{0}.asset";
        public readonly static string Format_ResourcesSystemAssetPath = "Assets/" + SysConst.Dir_Resources + "/" + SysConst.Dir_System + "/{0}.asset";
        #endregion
