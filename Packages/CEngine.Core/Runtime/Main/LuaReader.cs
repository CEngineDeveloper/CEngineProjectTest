    ...
    public static class LuaReader
    {
        ...
        private static object CreateObj(Table luaTable, Type type, out Type newType)
        {
            ...
            try
            {
                ...
                if (temp != null)
                {
                    createObjFromAssembly(nameSpace,Starter.AssemblyGameLogic, ref newType,ref cObject,ref temp);
                    if (cObject == null)
                    {
                        createObjFromAssembly(nameSpace, Starter.AssemblyCEngine, ref newType, ref cObject, ref temp);
                        if (cObject == null)
                        {
