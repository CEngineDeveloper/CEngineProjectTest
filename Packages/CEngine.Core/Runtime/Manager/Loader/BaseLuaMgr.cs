...
namespace CYM
{
    public sealed class BaseLuaMgr : BaseGFlowMgr, ILoader
    {
        #region callback val
        ...
        public static Script Lua { get; private set; } = new Script();
        ...
        public void DoString(string luaStr, string fileName = "", bool isLogFileName = true)
        {
        ...
        private string CustomCoreLuaString()
        {
            return "";
        }
        ...
        public IEnumerator Load()
        {
            ...
            if (BaseGlobal.Ins.IsLoadLua)
            {
                ...
                foreach (var dlc in DLCManager.LoadedDLCItems.Values)
                {
                    ...
                    {
                        var assetBundle = DLCManager.LoadRawBundle(dlc.Name ,SysConst.BN_Lua);
                        if (assetBundle != null)
                        {
