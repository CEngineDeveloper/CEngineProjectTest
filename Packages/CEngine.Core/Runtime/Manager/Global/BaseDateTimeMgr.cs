...
namespace CYM
{
    public sealed class BaseDateTimeMgr : BaseGFlowMgr
    {
        #region prop
        ...
        public GameDateTimeType CurDateTimeAgeType { get; private set; } = GameDateTimeType.BC;
        public GameDateTimeType StartDateTimeAgeType { get; private set; } = GameDateTimeType.BC;
        public DateTime CurDateTime { get; private set; } = new DateTime(1, 3, 1);
        public DateTime StartDateTime { get; private set; } = new DateTime(1, 1, 1);
