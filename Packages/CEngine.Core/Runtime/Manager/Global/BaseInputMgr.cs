...
namespace CYM
{
    public class BaseInputMgr : BaseGFlowMgr
    {
        ...
        protected static InputActionAsset InputAsset => GameConfig.Ins.InputActionAsset;
        #endregion
        ...
        {
            base.OnAllLoadEnd2();
            TouchDPI = Mathf.Max(Screen.dpi, GameConfig.Ins.TouchDPI);
            DragDPI = Mathf.Max(Screen.dpi, GameConfig.Ins.DragDPI);
            if (InputAsset == null)
            {
        ...
        protected virtual void OnRegisterAction()
        { 
