...
namespace CYM
{
    public sealed class Version
    {
        ...
        public static string GameVersion => GameConfig.ToString();

        public static bool IsTrialPlat => PlatformSDK.GetDistributionName() == nameof(PlatformSDK.Trial);
        public static int DataVersion => GameConfig.Data;
        ...
        public static string FullVersion => string.Format("{0} {1} {2}", BuildConfig.Name,GameConfig.ToString(), LocalConfig.Platform);
        ...
        /// <returns></returns>
        public static bool IsInData(int data)=> GameConfig.Ins.Data == data;
        #endregion
