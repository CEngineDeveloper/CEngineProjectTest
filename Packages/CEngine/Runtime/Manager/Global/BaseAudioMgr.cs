...
namespace CYM
{
    public sealed class BaseAudioMgr : BaseMgr
    {
        #region prop
        public const float DefaultMaxDistance = 18.0f;
        private HashSet<AudioClip> CacheAudioClip = new HashSet<AudioClip>();
        private HashSet<string> CacheAudioClipKey = new HashSet<string>();
        private ISettingsMgr<DBBaseSettings> SettingsMgr => BaseGlobal.SettingsMgr;
        public AudioListener AudioListener { get; private set; }
        public SoundManager Ins { get; private set; }
        public bool IsEnableSFX { get; private set; } = true;
        ...
        #region real
        public float GetRealVolumeVoice()
        {
            if (SettingsMgr == null)
                return 1;
