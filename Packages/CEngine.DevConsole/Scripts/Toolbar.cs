...
namespace CYM.DevConsole
{
    ...
    public class Toolbar {
        ...
        void DrawButtonsPanel(ref Rect rect) {
            ...
            DrawGenericButton(ref rect, clearContent, DevConsole.Ins.ClearLog);
            rect.x += rect.width;
            rect.x += spacing;
            ...
            rect.x += rect.width;
            rect.x += spacing;
            DrawGenericButton(ref rect, settingsContent, DevConsole.Ins.ToggleSettings);
            rect.x += rect.width;
            rect.x += padding;
        ...
        void SaveLogToFile() {
            ...
            using(StreamWriter writer = File.CreateText(fullPath)) {
                Entry[] entries = DevConsole.Ins.GetEntries();
            ...
            DevConsole.Ins.Log("Succesfully saved log to " + fullPath);
        }
