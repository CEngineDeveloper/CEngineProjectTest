...
namespace CYM.TransformTools
{
    public static class TransformTools
    {
        ...
        public static void AlignGlobal(GameObject[] selection, RelativeTo relativeTo,
            CYM.TransformTools.AxesUtils.Axis axis, Bound bound,
        ...
        public static void AlignLocal(GameObject[] selection, RelativeTo relativeTo, CYM.TransformTools.AxesUtils.Axis axis,
        ...
        public static void Align(GameObject[] selection, RelativeTo relativeTo, CYM.TransformTools.AxesUtils.Axis axis,
        ...
        #endregion
        #region DISTRIBUTE
        public static void Distribute(GameObject[] selection, CYM.TransformTools.AxesUtils.Axis axis, Bound bound)
        {
        ...
        public static void DistributeGaps(GameObject[] selection, CYM.TransformTools.AxesUtils.Axis axis,
        ...
        public class ArrangeData
        {
            ...
            private System.Collections.Generic.List<CYM.TransformTools.AxesUtils.Axis> _priorityList
                = new System.Collections.Generic.List<CYM.TransformTools.AxesUtils.Axis>
                { CYM.TransformTools.AxesUtils.Axis.X, CYM.TransformTools.AxesUtils.Axis.Y, CYM.TransformTools.AxesUtils.Axis.Z };
            ...
            public ArrangeAxisData GetData(CYM.TransformTools.AxesUtils.Axis axis)
            {
                return axis == CYM.TransformTools.AxesUtils.Axis.X ? x : axis == CYM.TransformTools.AxesUtils.Axis.Y ? y : z;
            }
            public void UpdatePriorities(CYM.TransformTools.AxesUtils.Axis axis)
            {
            ...
            public CYM.TransformTools.AxesUtils.Axis GetAxisByPriority(int priority) => _priorityList[priority];
        ...
        public class ProgressionData
        {
            ...
            public Rect GetRect(CYM.TransformTools.AxesUtils.Axis axis)
            {
                switch (axis)
                {
                    case CYM.TransformTools.AxesUtils.Axis.X:
        ...
        public class UnoverlapData
        {
            ...
            public UnoverlapAxisData GetData(CYM.TransformTools.AxesUtils.Axis axis)
            {
                return axis == CYM.TransformTools.AxesUtils.Axis.X ? _x : axis == CYM.TransformTools.AxesUtils.Axis.Y ? _y : _z;
            }
        }
        ...
        private class OverlapedObject
        {
            ...
            private void MoveTest(CYM.TransformTools.AxesUtils.Axis axis, bool unoverlap,
            ...
            public bool ExecuteBestSolution(UnoverlapData unoverlapData)
            {
                ...
                {
                    MoveTest(CYM.TransformTools.AxesUtils.Axis.X, unoverlapData.x.unoverlap, solution, ref minVol, ref bestMove);
                    MoveTest(CYM.TransformTools.AxesUtils.Axis.Y, unoverlapData.y.unoverlap, solution, ref minVol, ref bestMove);
                    MoveTest(CYM.TransformTools.AxesUtils.Axis.Z, unoverlapData.z.unoverlap, solution, ref minVol, ref bestMove);
                }
        ...
        private static float GetVectorComponent(Vector3 v, CYM.TransformTools.AxesUtils.Axis axis)
        {
            return axis == CYM.TransformTools.AxesUtils.Axis.X ? v.x : axis == CYM.TransformTools.AxesUtils.Axis.Y ? v.y : v.z;
        }

        private static Vector3 GetMoveVector(float move, CYM.TransformTools.AxesUtils.Axis axis)
        {
            return new Vector3(axis == CYM.TransformTools.AxesUtils.Axis.X
                ? move : 0f, axis == CYM.TransformTools.AxesUtils.Axis.Y
                ? move : 0f, axis == CYM.TransformTools.AxesUtils.Axis.Z ? move : 0f);
        }

        private static void GetOverlapedDataAxis(CYM.TransformTools.AxesUtils.Axis axis, UnoverlapData unoverlapData,
